...
<body>
    ...
    <div id="endereco" style="padding: 0%;">
        ...
        <div id="cardlogin" style="height: 420px;">
            <h2 style="position: relative; top: -40px; margin-top: 60px;">Alterar segmento</h2>
            ...
            <div id="formlogin">
            <p style="position: absolute; margin: 0px; padding: 0px; top: -110px;"> ID do segmento:</p>
            
            <input type="number" style="position: absolute; top: -110px; width: 60px; left: 140px; height: 22px; text-align: center;" id="numeroleratt">
                ...
                <button id="btn-enviaratt-seg">Enviar</button>
            </div>
    </div>
    ...
    <?php
        ...
        el = document.getElementById('btn-enviaratt-seg');
        if(el != null){
            el.addEventListener('click', function(){ atualizarSegmento('".$url."','".$_SESSION['token']."') });
        }
