...
<body>
    ...
    <div id="container" style="height: 800px;">
        ...
        <div id="cardlogin" style="height: 700px;">
            ...
            <button style="display: block; position: relative; width: 140px; left: 130px; height: 35px; font-size: 16px; margin-top: 40px; background-color: red; border: none; border-radius: 7px; color: white;" id="btn-erase">Apagar Ponto</button>
    ...
    <?php
        ...
        if(el != null){
            el.addEventListener('click', function(){ excluirponto('".$url."','".$_SESSION['token']."') });
        }
    </script>";
    ?>
</body>
